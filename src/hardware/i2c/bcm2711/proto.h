...
#define DELAYREG_FEDL_SHIFT_BITS        16
#define DELAYREG_FEDL_BIT_MSK           0xFFFF0000
#define DELAYREG_REDL_SHIFT_BITS        0
#define DELAYREG_REDL_BIT_MSK           0x0000FFFF
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/i2c/bcm2711/proto.h $ $Rev: 977387 $")
#endif
