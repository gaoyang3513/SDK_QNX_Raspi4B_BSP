...
extern const bcm2711_config_t rpi_board_config[3];
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/bcm2711/rpi4/rpi4_board_config.h $ $Rev: 963178 $")
#endif
