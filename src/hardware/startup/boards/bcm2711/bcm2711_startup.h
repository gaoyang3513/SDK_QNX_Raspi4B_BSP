...
typedef struct _bcm2711_config {
    bcm2711_pinmux_t *pinmux;
} bcm2711_config_t;
...
void put_miniuart(int character);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/bcm2711/bcm2711_startup.h $ $Rev: 963178 $")
#endif
