...
void
board_smp_init(struct smp_entry *smp, const unsigned num_cpus)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/bcm2711/board_smp.c $ $Rev: 963178 $")
#endif
